      ...
      <div className="space-y-8">
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
          <div>
            ...
            <p className="text-sm text-gray-500">Currently enrolled courses for the current semester.</p>
          </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          {enrollments?.map((enrollment: any) => (
            <Card key={enrollment.id} className="group hover:border-brand-500 transition-all hover:shadow-xl hover:shadow-brand-500/5 cursor-pointer overflow-hidden border-2 border-transparent">
              <div className="flex flex-col sm:flex-row gap-6">
                ...
                <div className="flex-1">
                  <div className="flex justify-between items-start mb-2">
                    <span className="text-[10px] font-bold text-brand-600 uppercase tracking-widest">{enrollment.courseCode}</span>
                    <span className="text-xs font-bold text-gray-400">{enrollment.credits} Credits</span>
                  </div>
                  <h3 className="text-xl font-bold text-gray-900 mb-4 group-hover:text-brand-700 transition-colors">{enrollment.title}</h3>
